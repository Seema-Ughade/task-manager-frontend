...
const linkData = [
  { key: "dashboard", icon: <MdDashboard style={{ color: "#1890ff" }} />, label: "Dashboard", to: "/dashboard", permission: "Manage Status" },
  { key: "departments", icon: <MdOutlinePendingActions style={{ color: "#fa8c16" }} />, label: "Departments", to: "/departments", permission: "Manage Department" },
  { key: "clients", icon: <FaUsers style={{ color: "#52c41a" }} />, label: "Clients", to: "/clients", permission: "Manage Clients" },
  { key: "projects", icon: <FaTasks style={{ color: "#13c2c2" }} />, label: "Projects", to: "/projects", permission: "Manage Projects" },
  {
    key: "tasks",
    icon: <FaTasks style={{ color: "#eb2f96" }} />,
    label: "Tasks",
